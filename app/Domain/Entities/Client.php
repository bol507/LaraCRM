 ...
 * @version 1.0.0
 * 
 * @see \App\Application\Repositories\ClientRepositoryInterface For persistence operations
 * @see \App\Infrastructure\Mappers\ClientMapper For database row to entity mapping
 * @see \App\Domain\Entities\ClientSummary For aggregated client statistics
 */
class Client
{
