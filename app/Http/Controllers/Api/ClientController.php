 ...
 * @version 1.0.0
 *
 * @see GetClientsUseCase For list operation logic
 * @see GetClientByIdUseCase For single client retrieval
 ...
 * @see ClientDto For response data structure
 * @see CreateClientRequest For creation request validation
 * @see UpdateClientRequest For update request validation
 */
class ClientController extends Controller
{
     ...
     * @see ClientSummary::toArray() For response structure
     */
