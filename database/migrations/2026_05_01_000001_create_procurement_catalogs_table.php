...
return new class extends Migration
{
    ...
    {
        Schema::connection($this->connection)->create('nova_procurement_catalogs', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::connection($this->connection)->dropIfExists('nova_procurement_catalogs');
    }
};