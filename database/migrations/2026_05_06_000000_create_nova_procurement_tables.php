...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        Schema::create('nova_vendor_quotes', function (Blueprint $table) {
            $table->id();
            ...
            $table->enum('status', ['draft', 'sent', 'submitted', 'negotiated', 'accepted', 'rejected'])->default('draft');
        ...
        // Quote Items
        Schema::create('nova_vendor_quote_items', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('nova_vendor_quote_items');
        Schema::dropIfExists('nova_vendor_quotes');
    }
};